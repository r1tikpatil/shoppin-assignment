...
const NEWS_URL = `https://newsapi.org/v2/everything?q=bitcoin&from=2025-03-11&sortBy=publishedAt&apiKey=${Constant.NEWS_API_KEY}`
const GOOGLE_CUSTOME_SEARCH_URL = `https://www.googleapis.com/customsearch/v1?key=${Constant.GOOGLE_API_KEY}&cx=${Constant.SEARCH_ENGINE_ID}&q=`
...
export const googleSearchData = async (searchQuery) => {
    const data = await apiRequest(GOOGLE_CUSTOME_SEARCH_URL + encodeURIComponent(searchQuery), "GET");
    return data;
}
